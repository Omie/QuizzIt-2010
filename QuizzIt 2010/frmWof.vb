Public Class frmWof
    ...
    Private Sub frmWof_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        commonInterface = Me
        wofForm = Me
...
#Region "interfacemembers"
    ...
    Public Sub spinWheel()
        ...
        Dim temp, temp1 As Short
        temp = rnd.Next(0.1, 0.9)
        temp1 = rnd.Next(40, 48)
        Dim power As Integer = temp1 + temp
        AxShockwaveFlash1.SetVariable("object.spin", power)
        AxShockwaveFlash1.SetVariable("object._rotation", "object._rotation = 0")
        AxShockwaveFlash1.SetVariable("object.spinning", "true")
    End Sub

    'Public Sub stopWheel()
    '    AxShockwaveFlash1.SetVariable("object.spinning", "false")
    'End Sub
    ...
    Public Sub showQuestion(ByVal argQuestion As String) Implements ICommonFormInterface.showQuestion
        If argQuestion = String.Empty Then
            ...
            AxShockwaveFlash1.Movie = Application.StartupPath & "\Rounds\" & currentStage & "\data\wofLast.swf"
        End If
        txtQuestion.Text = argQuestion
    End Sub
    Public Sub showAnswer(ByVal argAnswer As String) Implements ICommonFormInterface.showAnswer
        If Not argAnswer = String.Empty Then
